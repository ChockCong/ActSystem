...
<body>
	<div style="margin: 15px;">
		...
		<form class="layui-form" action="" method="post">
			...
			<div class="layui-form-item">
				<label class="layui-form-label">发布单位</label> <label
					class="layui-form-label"
					style="width: 200px; text-align: left; color: #999999;"><?php echo $_SESSION['xym']; ?>
</label>
			</div>
			<!--<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="respon" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<label class="layui-form-label">长号</label> <input type="tel"
						name="longtell" lay-verify="phone" autocomplete="off"
						class="layui-input">
				</div>
				<div class="layui-input-inline">
					<label class="layui-form-label">短号</label> <input type="tel"
						name="shorttell" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline">
						<input type="number" name="acnumber" lay-verify="number"
							autocomplete="off" class="layui-input">
					</div>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" name="acaddr" lay-verify="required"
			...
			<div class="layui-form-item">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline" style="width: 60px;">
						<input type="number" name="acduration" lay-verify="number"
							autocomplete="off" class="layui-input" style="width: 60px;">
					</div>
			...
			<div class="layui-form-item">
				<div class="layui-input-block">
					<submit type="submit" class="layui-btn" lay-submit="" value="立即发布">
