<?php /* Smarty version 2.6.30, created on 2017-03-06 14:02:01
...
<html>
	...
	<body ng-app="myApp" ng-controller="myCtrl">
		...
		<!--活动名单弹窗-->
		<div id="list">
			<label><p name="acname">三下乡社会实践活动</p>人员名单</label>
			               ...
			               success:function(data){
			            	   $.each(data,function(i,result){ 
			            		   $.each(result,function(j,val){
				            		   item = "<tr><td>"+val.snum+"</td><td>"+val.sname+"</td><td>"+val.szy+"</td><td>"+val.sdh+"</td><td><i class='fa fa-trash' aria-hidden='true' lay-submit=''></i></td></tr>"; 
				            		   $("#pman").append(item); 
			            		   }) 
			            		}); 
