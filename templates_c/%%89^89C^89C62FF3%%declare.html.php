<?php /* Smarty version 2.6.30, created on 2017-02-09 02:17:14
				...
				<div class="menuWindow">
					<ul class="p1">
						<li class="s1"><a href="#url"><div>活动申报</div></a>
							<ul class="p2">
								<li class="s2"><a href="UIcontroller.php?declare_title=1" target="change"><span>登记</span></a></li>
								<li class="s2"><a href="UIcontroller.php?declare_title" target="change"><span>修改</span></a></li>
								<li class="s2"><a href="UIcontroller.php?declare_title=3"><span>审批</span></a></li>
								</ul>
							</li>
						</ul>
					</div>
				</div>
		<iframe src="UIcontroller.php?declare_title=1" width="100%" height="100%" frameborder="0" name="change"></iframe>
		</div>
